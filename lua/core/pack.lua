...
-- pckr.nvim boot_strap
-- function pack:boot_strap()
--     local pckr_path = fn.stdpath("data") .. "/pckr/pckr.nvim"

--     if not (uv or vim.loop).fs_stat(pckr_path) then
--         fn.system({
--             'git',
--             'clone',
--             "--filter=blob:none",
...
--     self.config_path = fn.stdpath('config')
--     self:load_modules_packages()
--     -- print("[DEBUG] repos after loading modules:", vim.inspect(self.repos))
--     --TODO(glepnir): remove lazy it sourced the fil which in ftplugin twice !!!
--     require('pckr').add(self.repos)
-- end
